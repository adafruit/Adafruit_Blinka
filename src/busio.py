...
class SPI(Lockable):
    ...
    def write_readinto(self, buffer_out, buffer_in, out_start, out_end, in_start, in_end):
        return self._spi.write_readinto(self, buffer_out, buffer_in, out_start, out_end, in_start, in_end)
